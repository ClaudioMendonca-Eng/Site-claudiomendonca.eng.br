...
function translatorPage() {
	if (textTranslator.innerHTML === '&lt;HTML Lang="PT-BR"&gt;') {
		...
		textArticle01.innerHTML = '<article>O Claudio é um excelente profissional, tendo executado uma performance bastante elogiada, durante o tempo em que eu trabalhava na Parex , e pude acompanhá-lo no seu dia dia . Baseado nesse tempo é com satisfação que eu faço essa recomendação.</article><section><span class="cm-name">Paulo Cesar</span><span class="cm-post">SÓCIO-GERENTE - PVP COMERCIO E REPRESENTAÇÕES EIRELI</span></section>';
		textArticle02.innerHTML = '<article>Claudio profissional exemplar compromisso com o resultado, bom trabalho em equipe com uma forte sinergia e fortes conhecimentos na área de TI, Excel, Auto Cad entre outros. Super indico muito bom profissional.</article><section><span class="cm-name">Rogerio Martins</span><span class="cm-post">Gestor de manutenção | Supervisor manutenção - Sika</span></section>';
		textArticle02.innerHTML = '<article>Claudio é muito bom profissional. Esse parceiro recomendo, pois confio em suas competências para dar soluções coerentes as demandas difíceis! Claudio tem meu total apoio.</article><section><span class="cm-name">Humberto Santana</span><span class="cm-post">Fundador - Engenheiro Consultor Ltda</span></section>';
		...
		textArticle02.innerHTML = '<article>Claudio is an exemplary professional committed to results, good teamwork skills with strong synergy, and deep knowledge in the IT field, Excel, AutoCAD among others. Highly recommend, very skilled professional.</article><section><span class="cm-name">Rogerio Martins</span><span class="cm-post">Gestor de manutenção | Supervisor manutenção - Sika</span></section>';
		textArticle02.innerHTML = '<article>Claudio is a very skilled professional. I recommend this partner because I trust in his abilities to provide coherent solutions to difficult demands! Claudio has my full support.</article><section><span class="cm-name">Humberto Santana</span><span class="cm-post">Fundador - Engenheiro Consultor Ltda</span></section>';
